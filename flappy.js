...
function preload() {
    ...
    game.load.image("duck", "assets/flappy_duck.png")
...
function clickHandler(event) {
    game.add.sprite(game.add.sprite(event.x, event.y, "duck"));
    changeScore();
...
function generatePipe() {
    ...
    var gapSize = game.rnd.integerInRange(1, 3);
    for (var count = 0; count < 8; count += 1) {
        if (count < gapStart || count > gapStart + gapSize ) {
